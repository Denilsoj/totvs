...
E gostaria que voce me retornasse apenas, "sim" se algum dos campos citados (objeto, descricao e descricao) se encaixarem com o contexto dos termos ou "nao" caso contrário. Se o <objeto> e/ou <descricao> atender parcialmente, pode retornar "sim". Caso o <objeto>, <descricao> e/ou <descricao_completa> estejam incompletos, pode analisar o contexto a partir do que foi fornecido.

Note que a resposta deve ser baseada no contexto e nao apenas na presença dos termos. sempre escreva a resposta em letras minusculas e sem acentos!
</tarefa>
<exemplos>
...
<descricao_completa>{complete_description}</descricao_completa>
"""
